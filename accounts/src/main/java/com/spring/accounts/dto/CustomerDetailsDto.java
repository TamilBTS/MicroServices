...
@AllArgsConstructor
@Builder
@Schema(name = "Customer", description = "Schema to hold Customer, Accounts, Loans and Cards information")
public class CustomerDetailsDto {
    ...
    @Valid
    @Schema(name = "Cards Details of the customer")
    private CardsDto cardsDto;

    @Valid
    @Schema(name = "Loans Details of the customer")
